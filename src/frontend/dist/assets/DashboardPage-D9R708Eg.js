import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, a as composeRefs, b as reactDomExports, u as useComposedRefs, v as vt, d as cn, e as buttonVariants, f as useNavigate, m as motion, S as Search, L as Link, C as CirclePlus, B as Button, M as MapPin, T as TrendingUp } from "./index-Dra4aKhn.js";
import { I as Input, u as ue } from "./index-B4MtT_7t.js";
import { S as Skeleton } from "./skeleton-B-U1R3Ak.js";
import { u as useSavedSearches, a as useDeleteSearch } from "./useBackend-fR6Z4du_.js";
import { c as computeMetrics, g as getRankTier } from "./index-BXO32LPc.js";
/**
...
function SearchCard({
  ...
  const date = new Date(Number(search.createdAt) / 1e6);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.button,
    {
      ...
      onMouseEnter: (e) => {
        e.currentTarget.style.border = "1px solid rgba(99,51,255,0.5)";
        e.currentTarget.style.boxShadow = "0 0 24px rgba(99,51,255,0.2), 0 4px 24px rgba(0,0,0,0.4)";
      },
      onMouseLeave: (e) => {
      ...
      onClick: () => navigate({ to: "/search/$id", params: { id: search.id.toString() } }),
      "aria-label": `View ${search.businessName} — ${search.keyword}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 flex items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground truncate", children: search.businessName }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-cyan-400/70 mt-0.5 font-mono truncate", children: search.keyword })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RankBadge, { rank: metrics.avgRank })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 flex flex-col gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3 shrink-0 text-purple-400/60" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: search.address })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-3 h-3 shrink-0 text-purple-400/60" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: dateStr })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 flex gap-2 text-xs font-mono", children: [
...
function DashboardPage() {
  ...
  const filtered = (searches ?? []).filter((s) => {
    ...
    return s.businessName.toLowerCase().includes(q) || s.keyword.toLowerCase().includes(q);
  });
  ...
  const handleDeleteConfirm = () => {
    ...
    deleteSearch(pendingDeleteId, {
      onSuccess: () => {
        ue.success("Search deleted");
        setPendingDeleteId(null);
      },
      onError: () => {
        ue.error("Failed to delete search");
        setPendingDeleteId(null);
      }
    });
  };
  ...
  const pendingSearch = searches == null ? void 0 : searches.find((s) => s.id === pendingDeleteId);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-semibold text-lg text-foreground", children: "Saved Searches" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: searches && searches.length > 0 ? `${searches.length} tracked ${searches.length === 1 ? "business" : "businesses"}` : "Your tracked businesses and their grid rankings" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                searches && searches.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-cyan-400/50 pointer-events-none" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                  ...
                  Link,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        style: {
                          background: "linear-gradient(135deg, rgba(99,51,255,0.9) 0%, rgba(0,140,255,0.9) 100%)",
                          border: "1px solid rgba(120,80,255,0.6)",
                          boxShadow: "0 0 16px rgba(99,51,255,0.35), inset 0 1px 0 rgba(255,255,255,0.1)",
                          color: "#fff"
                        },
                        children: [
        ...
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: ["skel-a", "skel-b", "skel-c"].map((key) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 rounded-sm opacity-30" }, key))
          }
          ...
          "div",
          {
            ...
            children: sorted.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              SearchCard,
              {
                search: s,
        ...
        ) : filter && searches && searches.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0 },
            animate: { opacity: 1 },
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  style: {
                    ...
                    boxShadow: "0 0 20px rgba(99,51,255,0.3), inset 0 0 12px rgba(99,51,255,0.1)"
                  },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-6 h-6 text-purple-300" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-semibold text-foreground", children: "No searches yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 max-w-xs", children: "Run your first rank check to map your local SEO visibility across a 3×3 geographic grid" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      ...
                      style: {
                        background: "linear-gradient(135deg, rgba(99,51,255,0.9) 0%, rgba(0,140,255,0.9) 100%)",
                        border: "1px solid rgba(120,80,255,0.6)",
                        boxShadow: "0 0 20px rgba(99,51,255,0.4), inset 0 1px 0 rgba(255,255,255,0.1)",
                        color: "#fff"
                      },
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "w-3.5 h-3.5" }),
              ...
              AlertDialogContent,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-foreground", children: "Delete this search?" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: pendingSearch ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: pendingSearch.businessName }),
                      " ",
                      "— “",
